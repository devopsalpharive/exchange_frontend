...
export const getOrderBook = async (pairId) => {
    try {
        let respData = await axios({
            'url': `/derivative/orderBook/${pairId}`,
            'method': 'get',
        })
        return {
...
export const getRecentTrade = async (pairId) => {
    try {
        let respData = await axios({
            'url': `/derivative/recentTrade/${pairId}`,
            'method': 'get',
        })
        return {
            status: respData.data.success,
...
export const getOpenOrders = async (pairId, query) => {
    try {
        let respData = await axios({
            'url': `/derivative/openOrder/${pairId}`,
            'method': 'get',
            'params': query
        })
        return {
...
export const getuserPositionOrders = async (pairId, query) => {
    try {
        let respData = await axios({
            'url': `/derivative/positionOrders/${pairId}`,
            'method': 'get',
            'params': query
        })
        return {
...
export const getorderHistory = async (pairId, query) => {
    try {
        let respData = await axios({
            'url': `/derivative/orderHistory/${pairId}`,
            'method': 'get',
            'params': query
        })
        return {
...
export const getCloseOrders = async (pairId, query) => {
    try {
        let respData = await axios({
            'url': `/derivative/closedOrders/${pairId}`,
            'method': 'get',
            'params': query
        })
        return {
...
export const CancelTrade = async (orderId) => {
    try {
        let respData = await axios({
            'url': `/derivative/cancelOrder/${orderId}`,
            'method': 'get',
        })
        return {
            status: respData.data.success,
...
export const getChartData = async (tikerRoot) => {
    try {
        let respData = await axios({
            'url': `/derivative/chart/${tikerRoot}`,
            'method': 'get',
        })
        return {
            status: respData.data.success,

...
const NewToken = (props) => {
  ...
  const handleNewTokenNext = () => {
    navigate("/new-token-next");
  };
  return (
    <div>
      <Header props={props} />
          ...
          <div className="mt-4">
            ...
            <div className="mt-5">
              <h5 className="green_title mt-4">
                Details for the Token to be minted :
              </h5>
              <div className="d-flex flex-column mt-4 ">
            ...
            <div className="my-5 d-flex justify-content-center">
              <button className="grn_grd_btn" onClick={handleNewTokenNext}>
                {" "}
                Next
              </button>
            </div>

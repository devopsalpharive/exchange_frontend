...
const AlreadyMintedNext = (props) => {
  ...
  const handleAlreadyMintedSubmit = () => {
      ...
      <section className="custom_section">
        <div className="container container80 py-5">
          ...
          <div className="mt-4">
            ...
            <div className="mt-5">
              <h5 className="green_title">Tokenomics :</h5>
              <div className="d-flex flex-column mt-4 ">
            ...
            <div className="my-5 d-flex justify-content-center">
              <button
                ...
                onClick={handleAlreadyMintedSubmit}
              >
                {" "}
                Submit
              </button>
...
export default AlreadyMintedNext;

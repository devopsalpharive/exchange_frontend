...
// import { widget } from '../Chart/charting_library';//for new version 
...
const Chart = (props) => {
  ...
  const buildchart = (theme, pair) => {
    console.log("Datafeed URL:",props);
    const widgetOptions = {
      symbol: pair,
        ...
        return Promise.resolve([
          {
            ...
            metainfo: {
              ...
              description: 'AAA.HUMB.MOMENTUM', // 'Trading strategy using DMI and MACD',
...
Chart.defaultProps = {
  ...
  datafeedUrl: chartUrl + "/spot/chart",

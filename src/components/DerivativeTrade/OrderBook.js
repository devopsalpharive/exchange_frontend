        ...
        <div className="ob_table_head">
          <div className="row mx-auto align-items-center">
            <div className="col-3 px-0">
              <p className="text-start">Price ({derivativePair.secondCurrency})</p>
            </div>
            <div className="col-5 px-2">
              <p className="text-end">Amount ({derivativePair.firstCurrency})</p>
            </div>
            <div className="col-4 px-0">
              <p className="text-end">Total ({derivativePair.secondCurrency})</p>
            </div>
          </div>
        </div>
                      ...
                      <div className="row mx-auto">
                        ...
                        <div className="col-5 px-2">
                          <p className="text-end">
                            {isNaN(val?.quantity)
                              ? 0
                              : val?.quantity?.toFixed(derivativePair?.secondDecimal)}
                          </p>
                        </div>{" "}
                        <div className="col-4 px-0">
                          <p className="text-end">
                            {isNaN(val?.total)
                              ? 0
                              : val?.total?.toFixed(derivativePair?.firstDecimal)}
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="row mx-auto">
                <div className="col-4 px-0 d-flex flex-column align-items-start">
                  ...
                  <p className="ob_table_prft_value ">
                    {isNaN(derivativeTicker.last)
                      ? 0
                      : derivativeTicker?.last?.toFixed(derivativePair?.secondDecimal)}
                  </p>
                </div>
                ...
                <div className="col-4 px-0 d-flex flex-column align-items-end">
                  ...
                  <p
                    className={
                      derivativeTicker.change > 0
                        ? "ob_change_val val_green_txt"
                        : "ob_change_val val_red_txt"
                    }
                  >
                    {isNaN(derivativeTicker?.change)
                      ? 0
                      : derivativeTicker?.change?.toFixed(2)}
                  </p>
                </div>
              </div>
            </div>
                      ...
                      <div className="row mx-auto">
                        ...
                        <div className="col-5 px-2">
                          <p className="text-end">
                            {isNaN(val?.quantity)
                              ? 0
                              : val?.quantity?.toFixed(derivativePair?.firstDecimal)}
                          </p>
                        </div>{" "}
                        <div className="col-4 px-0">
                          <p className="text-end">

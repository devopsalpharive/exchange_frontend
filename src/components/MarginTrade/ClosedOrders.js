...
import { getCloseOrders } from "../../actions/MarginAction";
...
const CloseOrders = () => {
  ...
  useEffect(() => {
    socketContext.socket.on("MarginClosedPosition", (result) => {
        ...
        <table className="table">
          <thead>
            <tr>
              ...
              <th className="text-center">Balance ({marginPair.secondCurrency})</th>
            </tr>
          </thead>
          <tbody>
            {CloseOrder.length > 0 ? (
                    ...
                    <td className="text-center">
                      {isNaN(record?.entryPrice)
                        ...
                        : parseFloat(record?.entryPrice)?.toFixed(
                          marginPair?.secondDecimal
                        )}{" "}
                      {marginPair?.secondCurrency}
                    </td>
                    <td className="text-center">
